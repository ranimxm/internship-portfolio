...
//             var mainElement = document.getElementById("home-main");
...
//             point3 = null,
//             color = Math.round(random(220, 255)),
//             delay = 0;
...
//           if (this._ribbons.length <script this._options.ribbonCount) {
//             this.addRibbon();
//           }
...
<template>
  ...
  <!-- <main class="home-main" id="home-main">
    <div class="intro">
      ...
      <h4>
        a 22 year old It student currently in my third year at Fontys University.<br />
